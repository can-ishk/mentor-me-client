import {
  ...
  import { getMessages, sendMessage } from "../handlers/chats";
  ...
  const Messages = (props) => {
    ...
    useEffect(() => {
      socket && socket.on("receive-message", handleReceiveMessage);
    }, []);
    ...
    return props.conservant ? (
      ...
      >
        ...
        <Typography variant="h5">MentorMe Messenger</Typography>
        <Typography color="text.secondary">
          Private Messaging on MentorMe
        </Typography>
      </Stack>
    );
  };
